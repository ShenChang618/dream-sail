...
(function($) {
	...
	var Class = function() {};
	Class.extend = function argumentsCallee(prop) {
...
(function($, window, document, name) {
	...
	$.fn.offCanvas = function(options) {
		...
		this.each(function() {
			...
			offCanvasApi = new OffCanvas(self, options);
...
(function($, window, document, name) {
	...
	var togglePopover = function(popover, anchor, state) {
		...
		// console.log( popover.parentNode );
			...
			if (target.classList) {
				...
				if (classList.contains(CLASS_TABLE_VIEW_CELL)) {
					...
					if (!cell.parentNode.classList.contains(CLASS_GRID_VIEW)) {
						var link = cell.querySelector('.mui-navigate-right');
